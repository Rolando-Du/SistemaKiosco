...
## [1.5.0] - Exportación CSV en historiales

### Agregado

- Agregada exportación CSV en el historial de ventas.
- Agregada exportación CSV en el historial de compras.
- Agregado botón **Exportar ventas**.
- Agregado botón **Exportar compras**.
- Los archivos exportados se pueden abrir con Excel.
- La exportación respeta los filtros por fecha aplicados.
- Si no hay registros filtrados, el botón de exportación queda deshabilitado.

### Frontend

- Agregada utilidad reutilizable `exportarCsv.js`.
- Agregada función para generar nombres de archivo con fecha y hora.
- Agregada función para descargar archivos CSV desde el navegador.
- Mejorada la pantalla de historial de ventas.
- Mejorada la pantalla de historial de compras.
- Se exportan solo los registros visibles según el filtro aplicado.
- Se corrigieron clases visuales para mejorar compatibilidad con Tailwind.

### Backend

- No fue necesario modificar el backend.
- Se reutilizó la información ya disponible de ventas y compras.

### Repositorio

- Trabajo realizado en la rama `desarrollo-v1.5.0`.
- Cambios probados con build correcto del frontend.

---

## [1.4.0] - Filtros por fecha en historiales

### Agregado

- Agregados filtros por fecha en el historial de ventas.
- Agregados filtros por fecha en el historial de compras.
- Agregados campos **Fecha desde** y **Fecha hasta**.
- Agregado botón **Filtrar**.
- Agregado botón **Limpiar filtros**.
- Visualización de cantidad filtrada por período.
- Visualización de total filtrado por período.
- Visualización de promedio filtrado por período.

### Frontend

- Mejorada la pantalla de historial de ventas.
- Mejorada la pantalla de historial de compras.
- Los listados ahora se actualizan según el rango de fechas seleccionado.
- Las tarjetas resumen ahora muestran datos del período filtrado.
- El botón **Ver detalle** sigue funcionando sobre los registros filtrados.
- Se agregaron mensajes cuando no hay ventas o compras para el rango seleccionado.

### Backend

- No fue necesario modificar el backend.
- Se reutilizó el campo `fecha_creacion` ya disponible en ventas y compras.

### Repositorio

- Trabajo realizado en la rama `desarrollo-v1.4.0`.
- Cambios probados desde la interfaz.
- Build del frontend ejecutado correctamente.
